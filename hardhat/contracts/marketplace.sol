...
contract Marketplace is BucketApp, ObjectApp, GroupApp {
    ...
    function list(uint256 _objectId, string calldata _objectName, uint256 _groupId, string calldata _groupName, uint256 _price) external { //called after purchase listing
        require(
